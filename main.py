...
# 🔹 Help Command (Fixed MarkdownV2 issues)
async def help_command(update: Update, context: CallbackContext):
    help_text = (
        ...
        "/similar\\_bot \\- View similar bots\n\n"
        "🔗 *Join our Community:*\n"
...
# 🔹 Similar Bots Command (Fixed MarkdownV2 issues)
async def similar_bots(update: Update, context: CallbackContext):
    ...
    await update.message.reply_text("📌 *Similar Bots:*\nChoose from the list below:", parse_mode="MarkdownV2", reply_markup=reply_markup)
